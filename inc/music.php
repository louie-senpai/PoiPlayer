...
function poi_scripts() {
    ...
    wp_register_style('poi-fonts', POI_URL . '/build/css/font-awesome.min.css', array(), POI_VERSION, 'all');
...
function PoiPlayer_bar(){ 
  ...
  <div id="poi-play-bar" class="poi-play-bar poi-c">
    <div class="poi-control">
      ...
      <div class="poiplay playing loadMusic"><i class="fa fa-play"></i></div>
      <div class="fastforward"><i class="fa fa-forward"></i></div>
      ...
      <div class="shuffle-play"><i class="fa fa-random shuffle"></i></div>
      <div class="poi-volume"><i class="fa fa-volume-up mute"></i></div>
      <div class="poi-open-list"><i class="fa fa-bars"></i></div>
    </div>
    <div id="open-poi-player"><i class="fa fa-angle-right"></i></div><!-- Open Bar -->
  </div>
  ...
  <div id="music-json" class="music-json" style="display: none;">
    ...
    mautoplay = "<?php echo $poi['autoplay'];?>",
